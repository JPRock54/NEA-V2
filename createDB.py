...
def main():
    ...
    createTable("classes", "classID INT PRIMARY KEY, classRoom INT NOT NULL, classSubject VARCHAR(255) NOT NULL")
    createTable("suppliers", "supplierID INT PRIMARY KEY, supplierName VARCHAR(255) NOT NULL, supplierEmail VARCHAR(255) NOT NULL, supplierPhone VARCHAR(255) NOT NULL, supplierAddress VARCHAR(255) NOT NULL")
    createTable("categories", "categoryID INT PRIMARY KEY, categoryName VARCHAR(255) NOT NULL, categoryDescription VARCHAR(255) NOT NULL")
